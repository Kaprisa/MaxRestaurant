...
function auth(action){
	if (!$$('.js-show-user-popup').length) return
	$$('.js-show-user-popup').on('click', function(e){
		...
		if (action === 'login') {
			popup.querySelector('#confirmPassword').parentElement.style.display = 'none'
			popup.querySelector('#email').parentElement.style.display = 'none'
		} else {
			popup.querySelector('#confirmPassword').parentElement.style.display = 'block'
			popup.querySelector('#email').parentElement.style.display = 'block'
		}
